...
const Store = () => {
  ...
  const spotlightProducts = useMemo(() => {
    return products.filter((p) => p.brand === "Urban Explorer").slice(0, 2);
  }, [products]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700">
          <ProductShowcase
            ...
            linkTo="/explore" // Link to a future dedicated page
          />
        </div>
        <div className="border-t border-gray-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-950/50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
          <BrandSpotlight
            brand="Urban Explorer"
            title="Engineered for the City"
            description="Discover our collection of durable and stylish apparel, designed for the modern adventurer. From water-resistant jackets to versatile bags, Urban Explorer has you covered."
            imageUrl="https://images.pexels.com/photos/1687719/pexels-photo-1687719.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            products={spotlightProducts}
            linkTo="/explore?brand=Urban+Explorer"
          />
        </div>
        <FeaturedBrands/>
        <div className="border-t border-gray-200 dark:border-gray-700">
